...
namespace _7_2_DataParallelism_ParallelFor
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Parallel.For(0, employee.InsertEmployees().Count, i =>
            {
                Console.WriteLine(employee.InsertEmployees()[i].Id + " " +employee.InsertEmployees()[i].Name);
            });
        }
    }
